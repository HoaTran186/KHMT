...
class YoloDetect():
    def __init__(self, detect_class="person", frame_width=1280, frame_height=720):
        # Parameters
        self.classnames_file = "D:/Project/Intrusion_Warning/model/classnames.txt"
        self.weights_file = "D:/Project/Intrusion_Warning/model/yolov4-tiny.weights"
        self.config_file = "D:/Project/Intrusion_Warning/model/yolov4-tiny.cfg"
